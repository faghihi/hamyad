								...
								<div class="panel-body">
									<form class="form-horizontal" role="form" method="POST" action="{{ url('/password/reset') }}">
										...
										<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
											<label for="email" class="col-md-3 col-md-offset-1 text-right  control-label">ایمیل</label>
										...
										<div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
											<label for="password" class="col-md-3 col-md-offset-1 text-right  control-label">رمز عبور جدید</label>
										...
										<div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
											<label for="password-confirm" class="col-md-3 col-md-offset-1 text-right  control-label">تکرار رمز</label>
											<div class="col-md-7">
