		...
		<div class="main-wrapper scrollspy-container">
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<h1 class="page-title">سوالات متداول (FAQ)</h1>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
						...
						<div class="section-title mb-30">
							<h3 class="mb-10">سوالات متدوال از همیاد (FAQ)</h3>
							{{--<p class="text-sm">Man particular insensible celebrated conviction stimulated principles day. Sure fail or in said west. Right my front it wound cause fully am sorry if. She jointure goodness interest debating did outweigh.</p>--}}
						</div>
							...
							<div class="faq-section">
								...
								<div class="panel-group bootstarp-accordion" id="faq-accordion" role="tablist" aria-multiselectable="true">
									...
									<div class="panel">
										<div class="panel-heading" role="tab">
											<h4 class="panel-title">
												<a role="button" data-toggle="collapse" data-parent="#faq-accordion-one-8" href="#faq-accordion-one-8" aria-expanded="true" aria-controls="faq-accordion-one-8">How do I manange your accont?</a>
											</h4>
										</div>
									...
									<div class="panel">
										<div class="panel-heading" role="tab">
											<h4 class="panel-title">
												<a class="collapsed" role="button" data-toggle="collapse" data-parent="#faq-accordion-one" href="#faq-accordion-one-9" aria-expanded="false" aria-controls="faq-accordion-one-9">How do I set your accont?</a>
											</h4>
										</div>
									...
									<div class="panel">
										<div class="panel-heading" role="tab">
											<h4 class="panel-title">
												<a class="collapsed" role="button" data-toggle="collapse" data-parent="#faq-accordion-one" href="#faq-accordion-one-10" aria-expanded="false" aria-controls="faq-accordion-one-10">How do I delete my account?</a>
											</h4>
										</div>
									...
									<div class="panel">
										<div class="panel-heading" role="tab">
											<h4 class="panel-title">
												<a class="collapsed" role="button" data-toggle="collapse" data-parent="#faq-accordion-one" href="#faq-accordion-one-11" aria-expanded="false" aria-controls="faq-accordion-one-11">I forgot my password, what do I do? </a>
											</h4>
										</div>
									...
									<div class="panel">
										<div class="panel-heading" role="tab">
											<h4 class="panel-title">
												<a class="collapsed" role="button" data-toggle="collapse" data-parent="#faq-accordion-one" href="#faq-accordion-one-12" aria-expanded="false" aria-controls="faq-accordion-one-12">How do I change my password? </a>
											</h4>
										</div>
									...
									<div class="panel">
										<div class="panel-heading" role="tab">
											<h4 class="panel-title">
												<a class="collapsed" role="button" data-toggle="collapse" data-parent="#faq-accordion-one" href="#faq-accordion-one-13" aria-expanded="false" aria-controls="faq-accordion-one-13">Do I have to use my real name when I sign up? </a>
											</h4>
										</div>
									...
									<div class="panel">
										<div class="panel-heading" role="tab">
											<h4 class="panel-title">
												<a class="collapsed" role="button" data-toggle="collapse" data-parent="#faq-accordion-one" href="#faq-accordion-one-14" aria-expanded="false" aria-controls="faq-accordion-one-14">Can I sign in with more than one email address? </a>
											</h4>
										</div>
						...
						<div class="promo-box bg-dark mt-40">
					
							<div class="row">
								<div class="col-sm-10 col-md-8 col-sm-offset-1 col-md-offset-2">
									<h2>هنوز گیج هستید؟</h2>
							
									<p>سوالی ک ذهنتان را درگیر کرده است در سوالات بالا نبود؟</p>
									
									<a href="/contactUs" class="btn btn-primary mt-15">ارتباط با ما</a>
								</div>
							</div>
